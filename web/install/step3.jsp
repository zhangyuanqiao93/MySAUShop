...
<%@ page import="cn.edu.sau.eop.sdk.context.EopSetting" %>
<%
...
<div style="padding-left: 45px;"><h5 class="success"><br>请在下面建立商城管理员帐户：</h5></div>
<div id="show">
...
<table>
  <tbody>
   ...
   <%}else{ %>
   <input type="hidden" name="productid" value="shop">
    <%} %>
  <tr>
