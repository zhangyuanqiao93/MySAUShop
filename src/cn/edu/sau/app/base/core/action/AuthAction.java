...
import cn.edu.sau.app.base.core.service.auth.IAuthActionManager;
...
public class AuthAction extends WWAction {
	...
	private cn.edu.sau.app.base.core.model.AuthAction auth;
	public String add(){
		isEdit=0;
		return "input";
	} 
	...
	public String saveEdit(){
		...
		try{
			cn.edu.sau.app.base.core.model.AuthAction act = new cn.edu.sau.app.base.core.model.AuthAction();
			act.setName(name);
			act.setType("menu");
			act.setActid(authid);
	...
	public cn.edu.sau.app.base.core.model.AuthAction getAuth() {
		return auth;
	}

	public void setAuth(cn.edu.sau.app.base.core.model.AuthAction auth) {
		this.auth = auth;
	}
