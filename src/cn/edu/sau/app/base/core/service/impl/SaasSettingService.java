...
import cn.edu.sau.app.base.core.plugin.SettingPluginBundle;
...
public class SaasSettingService extends BaseSupport implements ISettingService {
	...
	/* (non-Javadoc)
	 * @see cn.sau.edu.app.setting.service.ISettingService#save()
	 */
	...
	/* (non-Javadoc)
	 * @see cn.sau.edu.app.setting.service.ISettingService#getSetting()
	 */
