...
import cn.edu.sau.javashop.core.service.impl.cache.ArticleCatCacheProxy;
import cn.edu.sau.javashop.core.service.impl.cache.GoodsCatCacheProxy;
...
public class ShopApp extends App {
	...
	public void install() {
		...
		this.cleanCache();
		//this.doInstall("file:cn/edu/sau/javashop/shop.xml");
	}
	/**
	 * 清除缓存
	 */
