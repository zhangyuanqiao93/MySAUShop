...
import cn.edu.sau.javashop.core.model.support.DlyTypeConfig;
import cn.edu.sau.javashop.core.model.support.TypeAreaConfig;
...
public interface IDlyTypeManager{
	 ...
	 * @param type 配送方式实体
	 * @param config 配送费用设置
	 * @see cn.sau.edu.test.shop.delivery.DeliveryTest#addSameTest
	 */
	 ...
	 * @see cn.sau.edu.test.shop.delivery.DeliveryTest#addDiffTest
	 */
	 ...
	 * @see cn.sau.edu.test.shop.delivery.DeliveryTest#testGetTypeForOrder
	 */
	 ...
	 * 	 	不保价时数组保价费用为null
	 * @see cn.sau.edu.shop.delivery.DeliveryTest#
	 */
