...
import cn.edu.sau.framework.database.DoubleMapper;
import cn.edu.sau.framework.database.Page;
import cn.edu.sau.framework.util.*;
...
import cn.edu.sau.javashop.core.plugin.order.OrderPluginBundle;
...
import cn.edu.sau.eop.sdk.utils.DateUtil;
...
import cn.edu.sau.framework.util.ExcelUtil;
import cn.edu.sau.framework.util.FileUtil;
import cn.edu.sau.javashop.core.model.OrderItem;
import cn.edu.sau.javashop.core.model.OrderLog;
...
import cn.edu.sau.javashop.core.service.OrderStatus;
...
//		double discount=  amount-price;
	...
	private String createSn(){
		Date now = new Date();
		String sn = DateUtil.toString(now, "yyyyMMddhhmmss");
		return sn;
	}
...
//			orderTotal+=protectPrice;
	...
	public String export(Date start, Date end) {
		...
		InputStream in = FileUtil.getResourceAsStream("cn/edu/sau/javashop/core/service/impl/order.xls");
		...
		filename =filename+ "/order"+ Math.random() +".xls";
