...
import cn.edu.sau.javashop.core.plugin.member.MemberPluginBundle;
...
import cn.edu.sau.framework.util.EncryptionUtil1;
...
public class MemberManager extends BaseSupport<Member> implements IMemberManager {
	...
	public int login(String username, String password) {
		...
		List<Member > list  =this.daoSupport.queryForList(sql, Member.class, username, StringUtil.md5(password));
