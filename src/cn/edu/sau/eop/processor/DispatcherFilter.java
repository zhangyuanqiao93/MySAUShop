...
import cn.edu.sau.eop.sdk.context.EopContextIniter;
import cn.edu.sau.eop.sdk.context.EopSetting;
import cn.edu.sau.eop.sdk.context.SaasEopContextIniter;
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		try {
			...
			if(!uri.startsWith("/install.html") &&uri.startsWith("/install")
				...
				httpResponse.getWriter().write("Please Delete /install/install.lock and reboot the web container if you want to reinstall the system.");
				return ;
			}
