package cn.edu.sau.eop.sdk.utils;
...
import cn.edu.sau.eop.processor.MultipartRequestWrapper;
import cn.edu.sau.eop.sdk.context.EopContext;
import cn.edu.sau.framework.context.webcontext.ThreadContextHolder;
import cn.edu.sau.framework.image.IThumbnailCreator;
import cn.edu.sau.framework.image.ThumbnailCreatorFactory;
...
public class UploadUtil {
	...
	public static String uploadUseRequest(String name,String subFolder){
		...
		try {
			...
			fileName = cn.edu.sau.framework.util.DateUtil.toString(new Date(), "yyyyMMddHHmmss") + StringUtil.getRandStr(4) + "." + ext;
