...
import cn.edu.sau.cms.core.service.IDataModelManager;
import cn.edu.sau.cms.core.service.impl.cache.DataCatCacheProxy;
...
//			sql.append("drop table if exists "+tbName+";\n");
	...
	public void install() {
		this.doInstall("file:cn/edu/sau/cms/cms.xml");
	}
